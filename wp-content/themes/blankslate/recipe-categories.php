<?php
/*
Template Name: Recipe Categories Page
*/
// Include header and other template parts
//get_header();
...
<body>
    ...
    <div class="recepie_area plus_padding">
        <div class="container">
            <div class="row">
                <?php
                // Get the current category from the query string
                $category_id = isset($_GET['category_id']) ? intval($_GET['category_id']) : 0;

                // Ensure proper category ID retrieval
                error_log('Category ID from URL: ' . $category_id);
                
                // WP Query to get recipes by category
                $args = array(
                    'post_type' => 'recipe',
                    'posts_per_page' => -1,
                    'orderby' => 'date',
                    ...
                    'tax_query' => array(
                        array(
                            'taxonomy' => 'category', // Replace with your taxonomy if different
                            'field'    => 'term_id',
                            'terms'    => $category_id,
                        ),
                    ),
